...
void MyStone::beep(int millisecs){
    char cmdFormat2[99];
    sprintf(cmdFormat2, "ST<{\"cmd_code\":\"set_buzzer\",\"type\":\"system\", \"time\":%i}>ET", millisecs);
    //ST<{"cmd_code": "set_buzzer", "type": "system", "time":100}>ET
	if(mySerial) mySerial->writeIt(cmdFormat2);
}
